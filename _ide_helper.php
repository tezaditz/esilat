 ...
 * Generated for Laravel 5.4.36 on 2018-11-13 01:05:15.
 *
...
namespace Vsmoraes\Pdf { 
    ...
    class PdfFacade {
         ...
         * @param \Vsmoraes\Pdf\Options $options
         * @return $this 
         * @static 
         */ 
        public static function setOptions($options)
        {
            return \Vsmoraes\Pdf\Dompdf::setOptions($options);
        }
         ...
         *
         * @see https://github.com/dompdf/dompdf/blob/master/src/Options.php
         * @return \Vsmoraes\Pdf\Options 
         * @static 
         */ 
        public static function getOptions()
        {
            return \Vsmoraes\Pdf\Dompdf::getOptions();
        }
         ...
         * @static 
         */ 
        public static function show($acceptRanges = false, $compress = true, $attachment = true)
        {
            \Vsmoraes\Pdf\Dompdf::show($acceptRanges, $compress, $attachment);
        }
        ...
        {
            return \Vsmoraes\Pdf\Dompdf::download();
        }
         ...
         * @static 
         */ 
        public static function output($compress = true)
        {
            return \Vsmoraes\Pdf\Dompdf::output($compress);
        }
...
namespace  { 
    ...
    class PDF2 extends \Vsmoraes\Pdf\PdfFacade {}
