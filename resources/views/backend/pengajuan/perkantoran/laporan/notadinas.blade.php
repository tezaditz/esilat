...
<table class="table" width="690px">
    ...
    <tr>
        <td>Hal</td>
        <td>:</td>
        <td>Permohonan Pelaksanaan Layanan Perkantoran</td>
    </tr>
...
<table class="table" width="100%">
    <tr>
        <td style="text-align: justify">Sehubungan akan dilaksanakannya layanan perkantoran berupa {{ $perkantoran->keterangan }} maka kami mengajukan rencana pembiayaan untuk kegiatan tersebut sebagai berikut:
        </td>
    </tr>
    <tr><th>&nbsp;</th></tr>
</table>
    ...
    <tr style="text-align: center">
      ...
      @foreach ($details as $key => $value)
        <tr>
            ...
            <td class="border" style="text-align: right" width="150px">{{ number_format($value->jumlah, 0) }}</td>
        </tr>
      @endforeach
    <tr>
        ...
        <th class="border" style="text-align: right">{{ number_format($details->sum('jumlah'), 0) }}</th>
    </tr>
</table>
<table class="table" width="100%">
    <tr><th>&nbsp;</th></tr>
