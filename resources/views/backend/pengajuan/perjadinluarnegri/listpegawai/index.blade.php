 ...
 */
?>
@extends('backend.pengajuan.perjadinluarnegri.listpegawai.base')

@section('title', trans('backend/master/pegawai.pegawai.index.title', ['total' => $total]), @parent)


@section('listpegawai-perjadin-luarnegeri')
    <div class="row">
        <div class="col-xs-12">
            @include('backend._inc.alerts')
            <form action="{{ route('pengajuan.perjadin-luar-negeri.pilih-pegawai', $perjadin_id) }}" method="POST">
                {{ csrf_field() }}
                ...
                <div class="box box-success">
                    ...
                    <div class="box-footer clearfix">
                        <a href="{{ route('pengajuan.perjadin-luar-negeri.detail-pelaksana', $perjadin_id) }}" type="button" class="btn btn-flat btn-danger btn-sm pull-left"><i class="fa fa-arrow-left"></i> @lang('backend/_globals.buttons.back')</a>
