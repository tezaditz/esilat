 ...
 */
?>
@extends('backend.pengajuan.perjadinluarnegri.detailakun.base')
...
@section('actions')
    @if($perjadinakuns->total() != 0)
        <a href="{{ route('pengajuan.perjadin-luar-negeri.detail-akun.list-akun', $perjadin_id) }}" class="btn bg-light-blue btn-sm"><i class="fa fa-plus"></i> @lang('backend/_globals.buttons.create')</a>
    @endif
@endsection

@section('detail-akun-perjadin-luarnegri')
	    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box box-success">
                <div class="box-header">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <form action="{{ route('pengajuan.perjadin-luar-negeri.detail-akun.search', $perjadin_id) }}" method="post" class="pull-right">
                            {{ csrf_field() }}
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach($perjadinakuns as $key => $perjadinakun)
                                <tr>
                                    ...
                                    <td class="text-right" style="width: 1px">{{ number_format($perjadinakun->jumlah_pengajuan ,0, ',', '.') }}</td>
                ...
                <div class="box-footer clearfix">
                    @if($perjadinakuns->total() > 0)
                        <a href="{{ route('pengajuan.perjadin-luar-negeri.detail-pelaksana', $perjadin_id) }}" class="btn btn-success btn-flat btn-sm">@lang('backend/_globals.buttons.next') <i class="fa fa-arrow-right"></i></a>
                    @endif
        ...
        <div class="modal fade" id="remove-modal{{ $perjadinakun->id }}">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form class="form-horizontal" action="{{ route('pengajuan.perjadin-luar-negeri.detail-akun.destroy', $perjadinakun->id) }}" method="post">
