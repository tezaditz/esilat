 ...
 */
?>
@extends('backend.pengajuan.perjadin.detailperjadin.base')
...
@section('actions')
   {{--  @role('user')
        ...
        <a href="#" class="btn bg-light-blue btn-sm" data-toggle="modal" data-target="#create-modal-guest"><i class="fa fa-plus"></i> @lang('backend/_globals.buttons.create_pel')</a>
    @endrole --}}
@endsection
            ...
            <div class="box box-success">
                <div class="box-header">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <form action="{{ route('pengajuan.perjadin-dalam-negeri.detail-pelaksana.search', $perjadin_id) }}" method="post" class="pull-right">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group pull-right">
                                <select class="form-control input-sm" name="options">
                                    <option value="nip">@lang('backend/pertanggungjawaban.perjadin.submodule.detail_perjadin.tables.nip')</option>
                                    <option value="nama_pelaksana">@lang('backend/pertanggungjawaban.perjadin.submodule.detail_perjadin.tables.nama_pelaksana')</option>
                    ...
                    @if($dataperjadins->total() > 0)
                        <table class="table table-hover table-bordered">
                            ...
                            <tr>
                                ...
                                <th class="text-right">
                                @role('user')
                                    <a href="#" class="btn bg-light-blue tn-flat btn-xs" data-toggle="modal" data-target="#create-modal" title="Tambah Pelaksana" style="float: left;"><i class="fa fa-plus"></i></a>
                                    <a href="#" class="btn btn-success tn-flat btn-xs" data-toggle="modal" data-target="#create-modal-guest" title="Tambah Pelaksana Lain" style="float: right;"><i class="fa fa-plus" ></i></a>
                                @endrole
                                </th>
                            </tr>
                        </table>
                    @else
                        <div class="text-center">
                            ...
                            @role('user')
                                ...
                                <a href="#" class="btn btn-success btn-sm" data-toggle="modal" data-target="#create-modal-guest"><i class="fa fa-plus"></i> @lang('backend/_globals.buttons.create_pel')</a>
                            @endrole
                            <br><br>
                        </div>
                    @endif
                ...
                <div class="box-footer clearfix">
                    @if($dataperjadins->total() > 0)
                        <a href="{{ route('pengajuan.perjadin-dalam-negeri.draft-perjadin', $perjadin_id) }}" class="btn btn-success btn-flat btn-sm">@lang('backend/_globals.buttons.next') <i class="fa fa-arrow-right"></i></a>
                    @endif
        ...
        <div class="modal fade" id="remove-modal{{ $dataperjadin->id }}">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form class="form-horizontal" action="{{ route('pengajuan.perjadin-dalam-negeri.detail-pelaksana.destroy', $dataperjadin->id) }}" method="post">
