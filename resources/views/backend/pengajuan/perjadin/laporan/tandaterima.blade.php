...
<col style="width: 139px">
  ...
  <tr>
    ...
    <td class="tg-smzr" colspan="5">: {{ date('d', strtotime($perjadin->tgl_awal)) }} s.d {{ date('d M Y', strtotime($perjadin->tgl_akhir)) }}</td>
  </tr>
  <tr>
    <td class="tg-smzr">Lokasi</td>
    <td class="tg-smzr" colspan="5">: {{ $perjadin->provinsi->title }}</td>
  </tr>
  <tr>
...
<col style="width: 138px">
  ...
  <tr>
    <th class="tg-123c" colspan="5">{{ $count++ }}. {{ $dataperjadin->nama_pelaksana }}</th>
    <th class="tg-yw4l"></th>
  </tr>
</table>
...
<col style="width: 192px">
  ...
  <tr>
    <th class="tg-g145" colspan="2" width="30%;">{{$dataperjadins[0]['nama_pelaksana']}}</th>
    <th class="tg-g145" colspan="2" width="30%;">{{$dataperjadins[1]['nama_pelaksana']}}</th>
    <th class="tg-vlr8" colspan="2">{{ $pimpinan->nama }}</th>
  </tr>
  <tr>
    <th class="tg-g145" colspan="2">NIP. {{$dataperjadins[0]['nip']}}</th>
    <th class="tg-g145" colspan="2">NIP. {{$dataperjadins[1]['nip']}}</th>
    <th class="tg-g145" colspan="2">NIP. {{ $pimpinan->nip }}</th>
  </tr>
</table>
...
<col style="width: 138px">
  ...
  <tr>
    <th class="tg-123c" colspan="4">{{ $count++ }}. {{ $dataperjadin->nama_pelaksana }}</th>
    <th class="tg-smzr"></th>
    <th class="tg-yw4l"></th>
  </tr>
</table>
...
<col style="width: 192px">
  ...
  <tr>
    <td class="tg-g145" colspan="2">{{ $dataperjadin->nip }}</td>
    <td class="tg-yw4l"></td>
    <td class="tg-yw4l"></td>
