    ...
    @if($perjadin->status->keterangan == 'PR91')
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="title" class="col-sm-3 control-label">@lang('backend/pertanggungjawaban.perjadin.submodule.draft_perjadin.tables.Provinsi_tujuan')</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="title"
                               value="{{ $perjadin->provinsi->title }}" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <label for="daerah_tujuan" class="col-sm-3 control-label">@lang('backend/pertanggungjawaban.perjadin.submodule.draft_perjadin.tables.daerah_tujuan')</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="daerah_tujuan"
                               value="{{ $perjadin->kabkota->nama }}" readonly>
                    </div>
                </div>
                <div class="form-group">
    ...
    <div class="col-xs-12">
        @role('bendahara')
            @if($perjadin->status->kode_status == 'PR00' || $perjadin->status->kode_status == 'PR01' || $perjadin->status->kode_status == 'PR02')
                <div class="row">
                    <div class="col-md-12">
                        <form method="POST" action="{{ route('pengajuan.perjadin-dalam-negeri.draft-perjadin.kirim-bendahara') }}" class="form-horizontal">
                            {{ csrf_field() }}
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group input-group-sm">
                                                    <select class="form-control" id="status_id" name="status_id" style="width: 100%;" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="alasan" class="form-control" id="alasan" disabled></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="box-footer">
                                <a href="{{ route('pengajuan.perjadin-dalam-negeri.index') }}" class="btn btn-danger btn-flat btn-sm pull-left"><i class="fa fa-arrow-left"></i> @lang('backend/_globals.buttons.cancel')</a>
                                <button type="submit" class="btn btn-primary btn-flat btn-sm pull-right" style="margin-right: 5px;">
            ...
            @elseif($perjadin->status->kode_status == 'PR03')
                <a href="{{ route('pengajuan.perjadin-dalam-negeri.index') }}" class="btn btn-danger btn-flat btn-sm pull-left"><i class="fa fa-arrow-left"></i> @lang('backend/_globals.buttons.cancel')</a>
                <a href="{{ route('pengajuan.perjadin-dalam-negeri.draft-perjadin.uang-diserahkan', $perjadin_id) }}" class="btn btn-success btn-flat btn-sm pull-right"><i class="fa fa-rub"></i> Uang Diserahkan </a>
                <a href="{{ route('pengajuan.perjadin-dalam-negeri.draft-perjadin.tanda-terima', $perjadin_id) }}" class="btn btn-default btn-flat btn-sm pull-right" target="_blank"><i class="fa fa-print"></i> Tandaterima </a>
            @else
                <div class="box-footer">
                    <a href="{{ route('pengajuan.perjadin-dalam-negeri.index') }}" class="btn btn-danger btn-flat btn-sm pull-left"><i class="fa fa-arrow-left"></i> @lang('backend/_globals.buttons.cancel')</a>
                </div>
        ...
        @role('user')
            @if($perjadin->status->kode_status == 'PR00')
                <a href="{{ route('pengajuan.perjadin-dalam-negeri.index') }}" class="btn btn-danger btn-flat btn-sm"><i class="fa fa-arrow-left"></i> @lang('backend/_globals.buttons.back')</a>
                <a href="{{ route('pengajuan.perjadin-dalam-negeri.draft-perjadin.kirim-perjadin', $perjadin_id) }}" class="btn btn-primary btn-flat btn-sm pull-right" style="margin-right: 5px;"><i class="fa fa-send"></i> @lang('backend/_globals.buttons.send')</a>
                {{--<a href="#" class="btn bg-yellow color-palette btn-flat btn-sm pull-right" style="margin-right: 5px;"><i class="fa fa-times"></i> Batal</a>--}}
            @elseif($perjadin->status->kode_status == 'PR01' || $perjadin->status->kode_status == 'PR02' || $perjadin->status->kode_status == 'PR03' || $perjadin->status->kode_status == 'PR91' )
                <a href="{{ route('pengajuan.perjadin-dalam-negeri.index') }}" class="btn btn-danger btn-flat btn-sm"><i class="fa fa-arrow-left"></i> @lang('backend/_globals.buttons.cancel')</a>
            @endif
        @endrole
    </div>
</div>
