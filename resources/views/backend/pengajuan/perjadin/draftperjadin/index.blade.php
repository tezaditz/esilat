 ...
 */
?>
@extends('backend.pengajuan.perjadin.draftperjadin.base')

@section('title', trans('backend/pertanggungjawaban.submodule.draft_perjadin'),  @parent)

@section('actions')

@endsection

@section('draft-perjadin')
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_3-1">
                        @include('backend.pengajuan.perjadin.draftperjadin.data-perjadin')
                    </div>
                    <div class="tab-pane" id="tab_2-2">
                        @include('backend.pengajuan.perjadin.draftperjadin.data-pelaksana')
                    </div>
                    <div class="tab-pane" id="tab_1-3">
                        @include('backend.pengajuan.perjadin.draftperjadin.data-jadwal')
                    </div>
                </div>
            </div>
        </div>
