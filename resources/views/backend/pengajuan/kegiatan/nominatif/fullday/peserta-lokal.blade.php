<div class="box">
        <div class="box-header">
            ...
            <div class="w3-btn-group">
                ...
                <a href="#" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#removeAllfdlocal-modal"><i
    ...
    <div class="modal fade" id="remove-modal{{ $nominatif_fullday_lokal->id }}">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" action="{{ route('pengajuan.kegiatan.nominatif.destroy', $nominatif_fullday_lokal->id) }}" method="post">
...
<div class="modal fade" id="removeAllfdlocal-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" action="{{ route('pengajuan.kegiatan.nominatif.fulldayLocal', $kegiatan_id) }}" method="post">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">@lang('backend/_globals.buttons.delete') @lang('backend/master/bagian.module')</h4>
