<div class="box">
        <div class="box-header">
            ...
            <div class="w3-btn-group">
                ...
                <a href="#" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#removeAllfbdaerah-modal"><i
        ...
        <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
                ...
                @if($nominatifs->count() > 0)
                    @foreach($nominatif_daerahs as $nominatif)
                        <tr>
...
@foreach($nominatif_daerahs as $nominatif_daerah)
    ...
    <div class="modal-content">
        <form class="form-horizontal" action="{{ route('pengajuan.kegiatan.nominatif.destroy', $nominatif_daerah->id) }}" method="post">
...
<div class="modal fade" id="removeAllfbdaerah-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" action="{{ route('pengajuan.kegiatan.nominatif.nominatifDaerah', $kegiatan_id) }}" method="post">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">@lang('backend/_globals.buttons.delete') @lang('backend/master/bagian.module')</h4>
