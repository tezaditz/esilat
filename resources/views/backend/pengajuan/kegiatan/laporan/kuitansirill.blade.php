...
<table class="table" width="100%">
    ...
    <tr>
      <td width="30%"></td>
      <td width="20%"></td>
      <td width="30%">PERATURAN MENTERI KEUANGAN REPUBLIK INDONESIA</td>
    </tr>
    <tr>
      <td width="30%"></td>
      <td width="20%"></td>
      <td width="30%">NOMOR 113/PMK.05/2012</td>
    </tr>
    <tr>
      <td width="30%"></td>
      <td width="20%"></td>
    ...
    <tr>
      <td width="30%"></td>
      <td width="20%"></td>
      <td width="30%">PERJALANAN DINAS JABATAN DALAM NEGERI BAGI PEJABAT</td>
    </tr>
    <tr>
      <td width="30%"></td>
      <td width="20%"></td>
      <td width="30%">NEGARA, PEGAWAI NEGERI, DAN PEGAWAI TIDAK TETAP</td>
    </tr>
...
<table class="table" width="100%">
    ...
    <tr>
        <td>Tanggal</td>
        <td>:</td>
        <td>{{ date('d', strtotime($nominatif->tgl_berangkat)) }} s.d {{ date('d M Y', strtotime($nominatif->tgl_kembali)) }}</td>
    </tr>
    <tr><th colspan="3">&nbsp;</th></tr>
</table>
<table class="table" width="100%">
...
<table class="table uraian" width="100%">
    ...
    <tr>
        <td class="border">Uang harian {{ $nominatif->lama }} Hari X {{ number_format($nominatif->uang_harian / $nominatif->lama , 0, ',', '.') }} </td>
        <td class="border" style="text-align: right" width="150px">{{ number_format($nominatif->uang_harian , 0, ',', '.') }}</td>
    <tr>
      <td class="border">Transport</td>
      <td class="border" style="text-align: right">{{ number_format($nominatif->transport , 0, ',', '.') }}</td>
    </tr>
    </tr>
    <tr>
        <th class="border" style="text-align: right">Total:</th>
        <th class="border" style="text-align: right">{{ number_format($nominatif->uang_harian + $nominatif->transport , 0, ',', '.') }}</th>
    </tr>
</table>
<table class="table" width="100%">
    <tr><th>&nbsp;</th></tr>
