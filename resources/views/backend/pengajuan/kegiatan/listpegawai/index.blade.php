 ...
 */
?>
@extends('backend.pengajuan.kegiatan.listpegawai.base')
...
@section('listpegawai')
    <div class="row">
        <div class="col-xs-12">
            ...
            <form action="{{ route('pengajuan.kegiatan.pilih-pegawai', $kegiatan_id) }}" method="POST">
                {{ csrf_field() }}
                ...
                <div class="box box-success">
                    ...
                    <div class="box-footer clearfix">
                        <a href="{{ route('pengajuan.kegiatan.draft-kegiatan', $kegiatan_id) }}" type="button" class="btn btn-flat btn-danger btn-sm pull-left"><i class="fa fa-arrow-left"></i> @lang('backend/_globals.buttons.back')</a>
