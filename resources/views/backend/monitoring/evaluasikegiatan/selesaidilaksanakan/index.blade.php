...
@section('title', trans('backend/monitoring/evaluasikegiatan.selesai_dilaksanakan.index.title', ['total' => $kegiatans->count()]), @parent)
            ...
            <div class="box box-success">
                <div class="box-header">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <form action="{{ route('monitoring.evaluasi-kegiatan.selesai-dilaksanakan.search') }}" method="post" class="pull-right">
                            {{ csrf_field() }}
