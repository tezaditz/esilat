...
@section('title', trans('backend/monitoring/evaluasikegiatan.sedang_diajukan.index.title', ['total' => $totalkegiatan]), @parent)
            ...
            <div class="box box-success">
                <div class="box-header">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <form action="{{ route('monitoring.evaluasi-kegiatan.sedang-diajukan.search') }}" method="post" class="pull-right">
                            {{ csrf_field() }}
