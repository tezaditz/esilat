 ...
 */
?>
@extends('backend.pertanggungjawaban.perjadin.detailperjadin.base')

@section('title', trans('backend/pertanggungjawaban.submodule.detail_perjadin'),  @parent)
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_3-1">
                        @include('backend.pertanggungjawaban.perjadin.detailperjadin.perjadin')
                    </div>
                    <div class="tab-pane" id="tab_2-2">
                        @include('backend.pertanggungjawaban.perjadin.detailperjadin.data-akun')
                    </div>
