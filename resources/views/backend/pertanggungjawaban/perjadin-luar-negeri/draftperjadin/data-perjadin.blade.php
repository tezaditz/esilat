    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="title" value="{{ $perjadin->negara->nama_negara }}" readonly>
                </div>
            </div>
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-xs-12">
            {{--<div class="col-md-6">--}}
                ...
                {{--</div>--}}
            {{--</div>--}}
            <form method="POST" action="{{ route('pertanggungjawaban.perjadin-luar-negeri.kirimbendahara', $perjadin->id) }}" class="form-horizontal">
                {{ csrf_field() }}
                <div class="col-md-offset-6 col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <a href="{{ route('pertanggungjawaban.perjadin-luar-negeri.index') }}" class="btn btn-danger btn-flat btn-sm"><i class="fa fa-arrow-left"></i> @lang('backend/_globals.buttons.cancel')</a>
