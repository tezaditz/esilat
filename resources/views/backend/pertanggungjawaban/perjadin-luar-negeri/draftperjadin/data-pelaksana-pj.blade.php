                ...
                <table class="table table-responsive table-hover table-bordered">
                    <tr>
                        <th class="bg-green color-palette" colspan="4">
                            ...
                            <a href="{{ route('pertanggungjawaban.perjadin-luar-negeri.draft-perjadin.kuitansi-rill', $data_perjadin->id) }}" class="btn btn-default btn-flat btn-xs pull-right" target="_blank"><i class="fa fa-print"></i> </a>
                        </th>
                    </tr>
                    <tr>
                        <th>Uraian</th>
