<form action="{{ route('pertanggungjawaban.perjadin-luar-negeri.kirim', $perjadin->id) }}" method="post">
    {{ csrf_field() }}
    ...
    @include('backend.pertanggungjawaban.perjadin-luar-negeri.detailperjadin.data-pelaksana-pj')
