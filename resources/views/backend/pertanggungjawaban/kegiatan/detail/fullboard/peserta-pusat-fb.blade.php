<div class="box box">
        <div class="box-header">
            ...
            <a href="#" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus-peserta-pusat-fb"><i class="fa fa-trash"></i> @lang('backend/_globals.buttons.delete')</a>
    ...
    <div class="modal fade" id="remove-modal{{ $nominatif->id }}">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" action="{{ route('pertanggungjawaban.kegiatan.hapus_nominatif', $nominatif->id) }}" method="post">
