<div class="box box">
        <div class="box-header">
            ...
            <a href="#" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus-peserta-pusat"><i class="fa fa-trash"></i> @lang('backend/_globals.buttons.delete')</a>
                ...
                @if($nominatif_fullday_pusats->count() > 0)
                    @foreach($nominatif_fullday_pusats as $nominatif_fullday_pusat)
                        <tr>
                            ...
                            <td class="text-right">{{  number_format($nominatif_fullday_pusat->penginapan ,0, ',', '.') }}</td>
    ...
    <div class="modal fade" id="remove-modal{{ $nominatif_fullday_pusat->id }}">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" action="{{ route('pertanggungjawaban.kegiatan.hapus_nominatif', $nominatif_fullday_pusat->id) }}" method="post">
