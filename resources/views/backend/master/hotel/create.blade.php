...
<div class="modal fade" id="create-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" action="{{ route('master.hotel.store') }}" method="post">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">@lang('backend/_globals.buttons.create') @lang('backend/master/hotel.module')</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 {{ $errors->has('nama_hotel') ? 'has-error' : '' }}">
                            <input type="text" name="nama_hotel" class="form-control" id="nama_hotel" placeholder="Hotel Rancamaya" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 {{ $errors->has('nama_perusahaan') ? 'has-error' : '' }}">
                            <input type="text" name="nama_perusahaan" class="form-control" id="nama_perusahaan" placeholder="PT Natural Adev Indonesia" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 {{ $errors->has('ktp') ? 'has-error' : '' }}">
                            <input type="text" name="ktp" class="form-control" id="ktp" placeholder="3671081708920004" required>
                            @if($errors->has('ktp'))
                                <span class="help-block">
                                    {{ $errors->first('ktp') }}
                                </span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 {{ $errors->has('npwp') ? 'has-error' : '' }}">
                            <input type="text" name="npwp" class="form-control" id="npwp" placeholder="01.855.081.4-412.000" required>
                            @if($errors->has('npwp'))
                                <span class="help-block">
                                    {{ $errors->first('npwp') }}
                                </span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 {{ $errors->has('nama_bank') ? 'has-error' : '' }}">
                            <input type="text" name="nama_bank" class="form-control" id="nama_bank" placeholder="Bank BRI" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 {{ $errors->has('no_rekening') ? 'has-error' : '' }}">
                            <input type="text" name="no_rekening" class="form-control" id="no_rekening" placeholder="71910100191****" required>
